...
export const metadata: Metadata = {
  title: 'Azerbaijan Visa on Arrival for Israeli Citizens 2026 | Lumivara Travel',
  description:
    'Israeli passport holders receive a 30-day visa on arrival at Heydar Aliyev International Airport in Baku. No advance application needed. Full guide from Lumivara Travel.',
  keywords: [
    'Azerbaijan visa on arrival Israeli citizens',
    'Azerbaijan visa Israel 2026',
    'Israel Azerbaijan visa on arrival',
    'Azerbaijan visa for Israeli passport',
    'Baku visa on arrival Israel',
    'Azerbaijan entry requirements Israel',
    'Azerbaijan travel Israel',
  ...
  openGraph: {
    title: 'Azerbaijan Visa on Arrival for Israeli Citizens 2026 | Lumivara Travel',
    description:
      'Israeli passport holders receive a 30-day visa on arrival at Heydar Aliyev International Airport. No advance application needed.',
  ...
  twitter: {
    ...
    title: 'Azerbaijan Visa on Arrival for Israeli Citizens 2026 | Lumivara Travel',
    description: 'Israeli passport holders receive a 30-day visa on arrival at Heydar Aliyev International Airport.',
      ...
      <section className="relative pt-24 pb-6 bg-primary overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-white mt-0 mb-5">
            Azerbaijan Visa on Arrival for Israeli Citizens — Complete 2026 Guide
          </h1>
          <p className="text-blue-200 text-lg max-w-2xl mx-auto leading-relaxed">
            Israeli passport holders receive a visa on arrival at Heydar Aliyev International Airport in Baku. No advance online application is needed — the visa is issued at the airport immigration desk on arrival.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-4 space-y-4">
        ...
        <section>
          ...
          <p className="text-gray-600 mb-5 leading-relaxed">
            Israeli citizens do not need to apply for a visa in advance. The visa is obtained on arrival at Heydar Aliyev International Airport, Baku. Verify the current visa fee at migration.gov.az before travelling.
          </p>
        ...
        <section>
          ...
          <ul className="space-y-3">
            {[
              { icon: '🛂', text: 'Valid Israeli passport with sufficient remaining validity' },
        ...
        <section>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mt-2 mb-3">Frequently Asked Questions — Azerbaijan Visa for Israeli Citizens</h2>
          <IsraelVisaFAQ />
        </section>
