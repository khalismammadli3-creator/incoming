...
export default function MalaysiaVisaGuidePage() {
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-4 space-y-4">
        ...
        <section>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mt-2 mb-3">Frequently Asked Questions — Azerbaijan Visa for Malaysian Citizens</h2>
          <MalaysiaVisaFAQ />
        </section>

        <section className="bg-primary rounded-2xl px-8 py-4 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">Planning a Trip to Azerbaijan from Malaysia?</h2>
          <p className="text-blue-200 mb-3 leading-relaxed max-w-xl mx-auto">
            Lumivara Travel handles complete itineraries, airport transfers, hotels and private tours across Azerbaijan — tailored for Malaysian travellers and groups.
          </p>
