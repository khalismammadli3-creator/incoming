...
const faqs = [
  {
    question: 'Is there visa on arrival for Pakistani citizens in Azerbaijan?',
    answer:
      'No — Pakistani passport holders cannot obtain a visa on arrival in Azerbaijan. The Azerbaijan e-Visa must be applied for in advance through the official ASAN Visa portal at evisa.gov.az. The process is entirely online and takes as little as 3 hours with urgent processing.',
  },
  {
    question: 'How much does the Azerbaijan visa cost for Pakistani citizens?',
    answer:
      'The total cost of an Azerbaijan e-Visa for Pakistani citizens is $29 USD, made up of a $20 USD government fee and a $9 USD service fee. This is payable online by Visa, Mastercard, UnionPay or JCB card. Several third-party websites charge significantly more — always apply at the official evisa.gov.az portal to pay only the official fee.',
  },
  {
...
export default function PakistanVisaFAQ() {
