...
import PakistanVisaFAQ from './PakistanVisaFAQ'

export const metadata: Metadata = {
  title: 'Azerbaijan Visa for Pakistani Citizens 2026 | Lumivara Travel',
  description:
    'Complete guide to the Azerbaijan e-Visa for Pakistani passport holders. Apply online at evisa.gov.az — $29 USD total fee, 3 working days standard processing, single entry, up to 30 days stay. No visa on arrival for Pakistani citizens.',
  keywords: [
    'Azerbaijan visa for Pakistani citizens',
    'Azerbaijan e-visa Pakistan 2026',
    'how to apply Azerbaijan visa from Pakistan',
    'Azerbaijan visa fee for Pakistanis',
    'Azerbaijan e-Visa Pakistan',
    'Azerbaijan visa requirements Pakistan',
    'ASAN visa Pakistan',
    'evisa Azerbaijan Pakistan',
  ],
  alternates: { canonical: 'https://incoming.lumivaratravel.az/visa-guide/pakistan/' },
  openGraph: {
    title: 'Azerbaijan Visa for Pakistani Citizens 2026 | Lumivara Travel',
    description:
      'Pakistani passport holders can apply for the Azerbaijan e-Visa online at evisa.gov.az — $29 USD, 3 working days, single entry, up to 30 days. No visa on arrival.',
    url: 'https://incoming.lumivaratravel.az/visa-guide/pakistan/',
  ...
  twitter: {
    ...
    title: 'Azerbaijan Visa for Pakistani Citizens 2026 | Lumivara Travel',
    description:
      'Pakistani passport holders can apply for the Azerbaijan e-Visa online — $29 USD, 3 working days, single entry. No visa on arrival for Pakistani citizens.',
    images: ['/images/hero.webp'],
  },
}

export default function PakistanVisaGuidePage() {
  return (
    <>
      <section className="relative pt-32 pb-24 bg-primary overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <span className="block text-accent font-semibold text-sm uppercase tracking-wider mb-3">Pakistani Citizens</span>
          <h1 className="text-4xl sm:text-5xl font-bold text-white mt-0 mb-5">
            Azerbaijan Visa for Pakistani Citizens — Complete 2026 Guide
          </h1>
          <p className="text-blue-200 text-lg max-w-2xl mx-auto leading-relaxed">
            Pakistani passport holders are eligible for the Azerbaijan e-Visa and can apply entirely online without visiting an embassy. Note: there is no Azerbaijan visa on arrival for Pakistani citizens — the e-Visa must be obtained in advance through the official portal.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
        ...
        <section>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mt-2 mb-3">Azerbaijan Visa at a Glance — Pakistani Passport</h2>
          <p className="text-gray-600 mb-5 leading-relaxed">
            The Azerbaijan visa fee for Pakistani citizens in 2026 is <strong>$29 USD</strong> in total — paid directly through the official government portal at evisa.gov.az.
          </p>
        ...
        <section>
          ...
          <ul className="space-y-3">
            {[
              { icon: '🛂', text: 'Valid Pakistani passport with at least 3 months of validity remaining beyond the e-Visa expiry date' },
        ...
        <section>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mt-2 mb-5">How to Apply — Azerbaijan e-Visa from Pakistan</h2>
          <p className="text-gray-600 mb-6 leading-relaxed">
            The Azerbaijan e-Visa application steps for Pakistani citizens below cover the full process on the official ASAN Visa portal — from registration to receiving your visa by email:
          </p>
          <ol className="space-y-4">
            {[
              ...
              'Fill in your personal details and Pakistani passport information accurately',
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed text-sm">
                  Always apply directly at <strong>evisa.gov.az</strong>. Several third-party websites charge up to $69 USD for the same visa — if you are wondering how much the Azerbaijan visa costs for Pakistani citizens, the answer is $29 USD through the official portal, not the inflated prices charged elsewhere. Lumivara Travel does not process visas — we always recommend applying through the official source only.
                </p>
              </div>
            </div>
          </div>
        ...
        <section>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mt-2 mb-6">Frequently Asked Questions — Azerbaijan Visa for Pakistani Citizens</h2>
          <PakistanVisaFAQ />
        </section>

        <section className="bg-primary rounded-2xl px-8 py-10 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">Planning a Trip to Azerbaijan from Pakistan?</h2>
          <p className="text-blue-200 mb-7 leading-relaxed max-w-xl mx-auto">
            Lumivara Travel handles complete itineraries, airport transfers, hotels and private tours across Azerbaijan — tailored for Pakistani travellers and groups.
          </p>
