...
export const metadata: Metadata = {
  title: 'Azerbaijan Visa on Arrival for Chinese Citizens 2026 | Lumivara Travel',
  description:
    'Chinese passport holders receive a 30-day visa on arrival at Heydar Aliyev International Airport in Baku. No advance application needed. Full guide from Lumivara Travel.',
  keywords: [
    'Azerbaijan visa on arrival Chinese citizens',
    'Azerbaijan visa China 2026',
    'China Azerbaijan visa on arrival',
    'Azerbaijan visa for Chinese passport',
    'Baku visa on arrival China',
    'Azerbaijan entry requirements China',
    'Azerbaijan travel China',
  ...
  openGraph: {
    title: 'Azerbaijan Visa on Arrival for Chinese Citizens 2026 | Lumivara Travel',
    description:
      'Chinese passport holders receive a 30-day visa on arrival at Heydar Aliyev International Airport. No advance application needed.',
  ...
  twitter: {
    ...
    title: 'Azerbaijan Visa on Arrival for Chinese Citizens 2026 | Lumivara Travel',
    description: 'Chinese passport holders receive a 30-day visa on arrival at Heydar Aliyev International Airport.',
      ...
      <section className="relative pt-32 pb-24 bg-primary overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-white mt-0 mb-5">
            Azerbaijan Visa on Arrival for Chinese Citizens — Complete 2026 Guide
          </h1>
          <p className="text-blue-200 text-lg max-w-2xl mx-auto leading-relaxed">
            Chinese passport holders receive a visa on arrival at Heydar Aliyev International Airport in Baku. No advance online application is needed — the visa is issued at the airport immigration desk on arrival.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-14">
        ...
        <section>
          ...
          <p className="text-gray-600 mb-5 leading-relaxed">
            Chinese citizens do not need to apply for a visa in advance. The visa is obtained on arrival at Heydar Aliyev International Airport, Baku. Verify the current visa fee at migration.gov.az before travelling.
          </p>
        ...
        <section>
          ...
          <ul className="space-y-3">
            {[
              { icon: '🛂', text: 'Valid Chinese passport with sufficient remaining validity' },
