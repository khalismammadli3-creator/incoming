...
export default function DestinationCard({ destination }: DestinationCardProps) {
  return (
    <Link href={`/${destination.slug}`} className="group block">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
        {/* Image */}
        ...
        <div className="p-5">
          <div className="flex items-start justify-between mb-2">
            <div>
              ...
              <p className="text-gray-500 dark:text-gray-400 text-sm mt-0.5">{destination.region}</p>
            </div>
            <div className="text-right flex-shrink-0 ml-4">
              <div className="text-xs text-gray-400 dark:text-gray-500">From</div>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-gray-500 dark:text-gray-400 text-xs ml-1">4.9</span>
            </div>
