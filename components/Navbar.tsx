      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <Link href="/" className="flex items-center">
            {scrolled ? (
              <img src="/images/logos/D_Medium.png" alt="Lumivara Travel" className="h-[50px] w-auto" />
            ) : (
              <img src="/images/logos/L_Medium.png" alt="Lumivara Travel" className="h-[50px] w-auto" />
            )}
          </Link>
